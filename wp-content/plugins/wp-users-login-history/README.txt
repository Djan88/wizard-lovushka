...
Tags: Login History, Last Login,Login Log, User detail, Mantain Login history, User Log
...
1. **IP Address** - Environment/Server IP address
1. **Country** (Based on IP Address)
1. **City** (Based on IP Address)
1. **Continent** (Based on IP Address)
1. **Timezone** (Based on IP Address)
1. **Latitude** (Based on IP Address)
1. **Longitude** (Based on IP Address)
1. **Browser** - Name and Version
1. **Operating System**
1. **Currency** - Code and Symbol

= Compatible With =
1. [WP Login Register Flow](https://wordpress.org/plugins/wp-login-register-flow/)
