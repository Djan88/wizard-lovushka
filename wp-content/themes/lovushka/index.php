      ...
      <div class="row">
        <div class="col-md-12">
          <div class="pull-left" style="padding-top: 7px;">
            v 2.3 | 2020 | <a class="ru_block" href="/oferta">Оферта</a><?php if(is_user_logged_in() && current_user_can('contributor')){ ?> | <button class="btn btn-success btn-xs" id="upgrade_btn">Полная версия</button><?php } ?>
          </div>
          <?php if(is_user_logged_in()){ ?>
      ...
      <div class="modal-content">
        ...
        <div class="modal-text">
          <div class="access_title">
            Вы можете перейти на <b>Расширенную весию</b> программы, это откроет доступ к режимам <b>"Пересмотр личной истории"</b> и <b>"Регрессивное центрирование"</b>. Чтоб узнать условия перехода заполните форму.
          </div>
